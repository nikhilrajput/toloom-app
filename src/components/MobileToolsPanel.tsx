    ...
    <>
      ...
      >
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
          <circle cx="17" cy="17" fill="white" className="opacity-40 group-hover:opacity-70 transition-opacity" r="17" />
        </svg>
            ...
            <>
              ...
              >
                <div className="absolute bottom-[-0.24%] left-[-0.24%] right-0 top-0">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 35 35">
                    <circle cx="17" cy="17.0806" fill="white" className="opacity-40 group-hover:opacity-70 transition-opacity" r="17" />
              ...
              <div className="fixed left-1/2 -translate-x-1/2 bottom-[12%] w-[327px] h-[65px] z-50">
                ...
                >
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 45 45">
                    <circle cx="22.5" cy="22.5" fill="white" className="opacity-40 group-hover:opacity-70 transition-opacity" r="22.5" />
              ...
              >
                <div className="flex h-full items-center justify-center rotate-[270deg]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
                    <circle cx="17" cy="17" fill="white" className="opacity-40 group-hover:opacity-70 transition-opacity" r="17" transform="rotate(90 17 17)" />
