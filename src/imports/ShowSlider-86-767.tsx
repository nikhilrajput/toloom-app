...
function StandardSlider() {
  return (
    <div className="absolute box-border content-stretch flex gap-[6px] items-center left-[113px] shadow-[0px_6px_25px_0px_rgba(0,0,0,0.1)] top-[798px] w-[194px]" data-name="Standard slider">
      <ActiveTrack />
      <Handle />
      <InactiveTrack />
    </div>
