    ...
    <div className="absolute left-0 size-[34px] top-0">
      <div className="absolute inset-[-55.88%_-73.53%_-91.18%_-73.53%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 84 84">
          <g id="Group 12">
            <g filter="url(#filter0_d_51_1124)" id="Ellipse 4">
              <circle cx="42" cy="36" fill="var(--fill-0, white)" fillOpacity="0.7" r="17" shapeRendering="crispEdges" />
            </g>
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="84" id="filter0_d_51_1124" width="84" x="0" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_51_1124" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_51_1124" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
...
function Cloud() {
  return (
    <div className="absolute left-[330px] size-[34px] top-[81px]" data-name="Cloud">
      <Group />
    </div>
  );
}
...
function Group2() {
  return (
    <div className="absolute contents left-[330px] top-[81px]">
      <Cloud />
      <p className="absolute font-['Roboto:SemiBold',sans-serif] font-semibold h-[25px] leading-[17px] left-[347px] text-[18px] text-black text-center top-[90px] translate-x-[-50%] w-[26px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        🌤️
      </p>
    </div>
  );
