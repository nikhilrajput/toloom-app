import svgPaths from "./svg-rvnvbb8evj";
...
function Undo3() {
  return (
    <div className="absolute left-[317px] size-[27px] top-[742px]" data-name="Undo">
      <Group5 />
    </div>
  );
}
...
function Delete3() {
  return (
    <div className="absolute left-[351px] size-[27px] top-[742px]" data-name="Delete">
      <Group6 />
      <Delete2 />
    </div>
  );
