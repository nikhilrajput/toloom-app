import svgPaths from "./svg-6zwdy5hy5u";
...
function Reed1() {
  return (
    <div className="absolute left-[318px] size-[48px] top-[712px]" data-name="Reed">
      <Reed />
    </div>
  );
}
...
function Group() {
  return (
    <div className="absolute contents left-[54px] top-[712px]">
      <div className="absolute left-[54px] size-[48px] top-[712px]">
      ...
      <p className="absolute font-['Roboto:SemiBold',sans-serif] font-semibold h-[17.143px] leading-[17px] left-[77.86px] text-[#72686f] text-[24px] text-center top-[727px] translate-x-[-50%] w-[21.714px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        1
      </p>
    </div>
  );
...
function Group4() {
  return (
    <div className="absolute contents left-[120px] top-[712px]">
      <div className="absolute left-[120px] size-[48px] top-[712px]">
        <div className="absolute inset-[-39.58%_-52.08%_-64.58%_-52.08%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 98 98">
            <g filter="url(#filter0_d_40_441)" id="Ellipse 4">
              <circle cx="49" cy="43" fill="var(--fill-0, white)" fillOpacity="0.7" r="24" shapeRendering="crispEdges" />
      ...
      <p className="absolute font-['Roboto:SemiBold',sans-serif] font-semibold h-[17.143px] leading-[17px] left-[143.43px] text-[#72686f] text-[24px] text-center top-[726.86px] translate-x-[-50%] w-[21.714px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        2
      </p>
    </div>
  );
...
function Group8() {
  return (
    <div className="absolute contents left-[186px] top-[712px]">
      <div className="absolute left-[186px] size-[48px] top-[712px]">
        <div className="absolute inset-[-39.58%_-52.08%_-64.58%_-52.08%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 98 98">
            <g filter="url(#filter0_d_40_441)" id="Ellipse 4">
              <circle cx="49" cy="43" fill="var(--fill-0, white)" fillOpacity="0.7" r="24" shapeRendering="crispEdges" />
      ...
      <p className="absolute font-['Roboto:SemiBold',sans-serif] font-semibold h-[17.143px] leading-[17px] left-[209.43px] text-[#72686f] text-[24px] text-center top-[726.86px] translate-x-[-50%] w-[21.714px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        3
      </p>
    </div>
  );
...
function Group9() {
  return (
    <div className="absolute contents left-[252px] top-[712px]">
      <div className="absolute left-[252px] size-[48px] top-[712px]">
        <div className="absolute inset-[-39.58%_-52.08%_-64.58%_-52.08%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 98 98">
            <g filter="url(#filter0_d_40_441)" id="Ellipse 4">
              <circle cx="49" cy="43" fill="var(--fill-0, white)" fillOpacity="0.7" r="24" shapeRendering="crispEdges" />
      ...
      <p className="absolute font-['Roboto:SemiBold',sans-serif] font-semibold h-[17.143px] leading-[17px] left-[275.86px] text-[#72686f] text-[24px] text-center top-[727px] translate-x-[-50%] w-[21.714px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        4
      </p>
    </div>
  );
...
function Group10() {
  return (
    <div className="absolute contents left-[18px] top-[700px]">
      <div className="absolute bg-[rgba(255,255,255,0.5)] h-[72px] left-[18px] rounded-[35px] shadow-[0px_6px_25px_0px_rgba(0,0,0,0.1)] top-[700px] w-[366px]" />
      <Reed1 />
      <Group />
      <Group4 />
      <Group8 />
...
function WeftColor() {
  return (
    <div className="absolute left-[117px] size-[45px] top-[621px]" data-name="Weft Color">
      <div className="absolute inset-[-42.22%_-55.56%_-68.89%_-55.56%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 95 95">
...
export default function IPhone16Pro() {
  return (
    <div className="bg-white relative size-full" data-name="iPhone 16 Pro - 2">
      ...
      <Delete3 />
      <Delete4 />
      <div className="absolute bg-[rgba(255,255,255,0.5)] h-[72px] left-[18px] rounded-[35px] shadow-[0px_6px_25px_0px_rgba(0,0,0,0.1)] top-[608px] w-[177px]" />
      <Auto1 />
      <Group10 />
      <Group7 />
      <Group11 />
